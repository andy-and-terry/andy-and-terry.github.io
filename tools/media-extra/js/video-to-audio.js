(function () {
  ...
  function updateOutputName() {
    ...
    outputName.value = baseName(currentFile.name) + "." + (formatSelect.value === "aac" ? "m4a" : formatSelect.value);
  }
  ...
  const MIMES = { mp3: "audio/mpeg", aac: "audio/mp4", wav: "audio/wav" };
  const EXTS = { mp3: "mp3", aac: "m4a", wav: "wav" };
